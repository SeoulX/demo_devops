...
```
cd existing_repo
git remote add origin https://gitlab.com/oaktree4/demo-devops.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/oaktree4/demo-devops/-/settings/integrations)
